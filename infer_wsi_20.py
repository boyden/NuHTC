...
# python tools/infer_wsi.py demo/wsi configs/nuhtc/htc_lite_swin_pytorch_fpn_PanNuke_seasaw_CAS.py models/pannuke.pth --out demo/wsi_res --patch --seg --stitch --space 256 --step_size 192 --target_spacing 0.5 --margin 2 --min_area 10 --save_dir demo/wsi_infer --mode merge --no_auto_skip
...
def main():
    ...
    cfg = Config.fromfile(f'{cfg_basename}_20.py')
    ...
    model.inst_fillColor = ["rgba(255, 0, 0, 0)", "rgba(0, 255, 0, 0)", "rgba(0, 0, 255, 0)", "rgba(255, 255, 0, 0)",
                            "rgba(255, 0, 255, 0)"]
