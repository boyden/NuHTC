...
from nuhtc.core import EvalHook
from nuhtc.datasets import build_dataloader
from nuhtc.utils import find_latest_checkpoint, get_root_logger, patch_runner
    ...
    if validate:
        ...
        if "type" not in eval_cfg:
            ...
            eval_hook = build_from_cfg(
                eval_cfg, HOOKS, default_args=dict(dataloader=val_dataloader, save_best='loss')
            )
