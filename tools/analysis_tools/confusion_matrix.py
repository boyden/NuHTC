...
def parse_args():
    ...
    parser.add_argument(
        ...
        'is allowed.')
    args = parser.parse_args(args=["/home/bao/code/SoftTeacher/work_dirs/htc_swin_pytorch_seasaw_FPN_AttenROI_CoNIC_full_epoch_200_20220223_004446/htc_swin_pytorch_fpn_CoNIC_seasaw.py", "/home/bao/code/SoftTeacher/results/CoNIC_res.pkl", "/home/bao/code/SoftTeacher/results"])
    return args
...
def plot_confusion_matrix(confusion_matrix,
    ...
    fig, ax = plt.subplots(
        figsize=(num_classes, num_classes * 0.8), dpi=300)
